		...
		<div class="row">
			<div class="col-lg-9 col-md-9 align-self-center">
				...
				<?php if ( get_theme_mod('medical_clinic_lite_header_phone_number') ) : ?>
					<span class="phone-number"><i class="fas fa-phone mr-2"></i><?php echo esc_html( get_theme_mod('medical_clinic_lite_header_phone_number' ) ); ?></span>
				<?php endif; ?>
			</div>
				    	...
				    	<div class="logo-content">
					    	<?php
					    		if ( get_theme_mod('medical_clinic_lite_display_header_title', true) == true ) :
						      	...
						      	if ( get_theme_mod('medical_clinic_lite_display_header_text', true) == true ) :
